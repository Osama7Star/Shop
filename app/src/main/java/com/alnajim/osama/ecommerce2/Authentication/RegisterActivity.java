...
import com.alnajim.osama.ecommerce2.sqlite.SessionManager;
...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputFullName    =  findViewById(R.id.tvPhoneNumber);
        btnRegister      =  findViewById(R.id.btnRegister);
        btnLinkToLogin   =  findViewById(R.id.btnGotoLogin);
        welcome          =  findViewById(R.id.tvWelcome);
        welcome1         = findViewById(R.id.tvWelcome1);
        // Progress dialog
        ...
        welcome1.setText(getResources().getString(R.string.welcome1));
...
//                    registerUser(name);
                    ...
                    Toast.makeText(getApplicationContext(),
                            getResources().getString(R.string.phoneempty), Toast.LENGTH_LONG)
                            .show();
                }
            }
        });
     ...
     * */
    private void registerUser(final String phonNumber) {
        ...
        StringRequest strReq = new StringRequest(Method.POST,
                RetrofitInterface.URL_REGISTER, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        String phoneNumber =  user.getString("name");
